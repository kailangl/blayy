...
const AddonPage: FC = () => {
    ...
    {addon.downloadbp && (
      ...
      {addon.downloadll && (
      <a
        href={addon.downloadll}
        target="_blank"
        className="hover:bg-blueborder shadow-blueshadow shadow-xl hover:text-black transition-colors duration-300 border-4 border-blueborder text-bluetext cursor-pointer bg-bluebg text-center p-2 px-4 font-bold flex flex-grow justify-center mt-10 w-[400px] tablet:w-[95vw]"
      >
        Download Addon - Lootlabs (mcpedl safe)
      </a>
    )}     
                            {addon.download && (
      <a
        href={addon.download}
        target="_blank"
        className="hover:bg-blueborder shadow-bluetext shadow-xl hover:text-black transition-colors duration-300 border-4 border-blueborder text-bluetext cursor-pointer bg-bluebg text-center p-2 px-4 font-bold flex flex-grow justify-center mt-10 w-[400px] tablet:w-[95vw]"
      >
        Download Addon
      </a>
    )}     
     {addon.downloadl && (
      ...
      <a
        href={addon.vip}
        target="_blank"
        className="hover:bg-vipborder shadow-vipshadow shadow-xl hover:text-black transition-colors duration-300 border-4 border-vipborder text-vipshadow cursor-pointer bg-vipshadow text-center p-2 px-4 font-bold flex flex-grow justify-center mt-10 w-[400px] tablet:w-[95vw]"
      >
        Direct Download (VIP)
      </a>
    )}           
