...
<div className="flex w-full items-center justify-center">
 ...
 {error && <p style={{ color: 'red' }}>{error}</p>}
        ...
        <div>
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdID-_VLuEe4WkmQSDLDTlBCpHCBNv-nIHqH8z-XSHTH-e7gw/viewform?embedded=true" width="640" height="1284" frameborder="0" marginheight="0" marginwidth="0">Carregando…</iframe>
        </div>
