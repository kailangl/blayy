...
const AboutPage: FC = () => {
   return (    
       ...
       <button onClick={() => window.location.href = "https://blayy.vercel.app"} className="shadow-blueshadow w-[25vw] h-[25%] shadow-xl hover:bg-blueborder hover:text-black transtion-colors duration-300 border-4 border-blueborder bg-bluebg text-center p-2 px-4 font-bold flex flex-grow justify-center w-full text-bluetext">HOME</button>
